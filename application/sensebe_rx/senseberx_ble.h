/*
 *  senseberx_ble.h : BLE Support file for SenseBe application 
...
#ifndef APPLICATION_SENSEBERX_BLE_H_
#define APPLICATION_SENSEBERX_BLE_H_
...
#define SENSEBERX_UUID_COMPLETE        {DEVICE_UUID_COMPLETE}
#else
#define SENSEBERX_UUID_COMPLETE        {0x0a, 0xde, 0xfb, 0x07, 0x74, 0x83, 0x66, 0xb0, 0x0d, 0x48, 0xf5, 0x07, 0x60, 0xdc, 0x73, 0x3c}
#endif
 ...
 * @param senseberx_ble_adv_data Advaertise data and scan response data along with
