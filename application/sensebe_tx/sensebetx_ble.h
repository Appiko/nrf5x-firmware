/*
 *  sensebetx_ble.h : BLE Support file for SenseBe application 
...
#ifndef APPLICATION_SENSEBETX_BLE_H_
#define APPLICATION_SENSEBETX_BLE_H_
...
#define SENSEBETX_UUID_COMPLETE        {DEVICE_UUID_COMPLETE}
#else
#define SENSEBETX_UUID_COMPLETE        {0x0a, 0xde, 0xfb, 0x07, 0x74, 0x83, 0x66, 0xb0, 0x0d, 0x48, 0xf5, 0x07, 0x60, 0xdc, 0x73, 0x3c}
#endif
/** The 16 bit UUID of the Sense Be service */
#ifdef DEVICE_UUID_SERVICE
#define SENSEBETX_UUID_SERVICE         DEVICE_UUID_SERVICE
#else
#define SENSEBETX_UUID_SERVICE         0xdc60
#endif
/** The 16 bit UUID of the read-only System Info characteristic */
#ifdef DEVICE_UUID_SYSINFO
#define SENSEBETX_UUID_SYSINFO         DEVICE_UUID_SYSINFO
#else
#define SENSEBETX_UUID_SYSINFO         0xdc61
#endif
/** The 16 bit UUID of the read-write Config characteristic */
#ifdef DEVICE_UUID_CONFIG
#define SENSEBETX_UUID_CONFIG         DEVICE_UUID_CONFIG
#else
#define SENSEBETX_UUID_CONFIG         0xdc62
#endif
...
typedef struct
{
    /** Variable to enable/disable Beam Tx */
    uint16_t is_enable;
    /** Variable to decide range */
    uint16_t range;
}beam_functionality_t;

/** Shared memory for functionality selection */
typedef union
{
    beam_functionality_t beam_func;
 ...
 * @param sensebetx_ble_adv_data Advaertise data and scan response data along with
