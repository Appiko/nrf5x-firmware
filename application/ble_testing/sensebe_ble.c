 ...
 */
uint8_t ble_gatts_buffer[sizeof(senseberx_config_t) + 74];

uint8_t data_buffer[206];

senseberx_config_t g_config;
...
void (* sensebe_config_t_update)(senseberx_config_t * cfg);
...
static void ble_evt_handler(ble_evt_t * evt) {
    ...
    switch (evt->header.evt_id) {
        ...
        case BLE_GATTS_EVT_WRITE:
        {
            ...
            sensebe_config_t_update((senseberx_config_t *) data_buffer);
