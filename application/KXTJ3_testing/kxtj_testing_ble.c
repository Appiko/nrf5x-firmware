/*
 *  kxtj_testing_ble.c : BLE Support file for LSM6D application 
...
//        kxtj_ble_adv_start(connected_callback);
...
void kxtj_ble_service_init(void)
{
    ...
    err_code = sd_ble_gatts_characteristic_add(
        h_kxtj_service, &char_md, &attr_char_value, &h_status_byte);
    APP_ERROR_CHECK(err_code);
