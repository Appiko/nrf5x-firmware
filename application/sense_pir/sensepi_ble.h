...
#ifndef APPLICATION_SENSEPI_BLE_H_
#define APPLICATION_SENSEPI_BLE_H_
...
typedef struct {
    ...
    /** Amplification factor for 2nd stage of amplifier. Min 0 and max is 63 */
    uint8_t amplification;

    /** Variable to decide ADC sensitivity */
    uint16_t threshold; 
...
} __attribute__((packed)) sensepi_ble_config_t; ///206Bytes
...
#endif /* APPLICATION_SENSEPI_BLE_H_ */
