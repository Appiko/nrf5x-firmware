...
{
//Clear events
#ifdef SAADC_CHANNEL_USED_PIR_SENSE
    pir_sense_saadc_Handler ();
    NRF_SAADC->EVENTS_CH[SAADC_CHANNEL_USED_PIR_SENSE].LIMITH = 0;
    NRF_SAADC->EVENTS_CH[SAADC_CHANNEL_USED_PIR_SENSE].LIMITL = 0;
#endif
#ifdef SAADC_CHANNEL_USED_SIMPLE_ADC
    NRF_SAADC->EVENTS_DONE = 0;
    NRF_SAADC->EVENTS_CH[SAADC_CHANNEL_USED_SIMPLE_ADC].LIMITH = 0;
    NRF_SAADC->EVENTS_CH[SAADC_CHANNEL_USED_SIMPLE_ADC].LIMITL = 0;
#endif
}

void TIMER0_IRQHandler (void)
{
#if defined TIMER_USED_AUX_CLK
#if TIMER_USED_AUX_CLK == 2
    aux_clk_timer_handler ();
#endif
#endif
...
#if defined RTC_USED_AUX_CLK
#if RTC_USED_AUX_CLK == 0
    aux_clk_rtc_handler ();
#endif
#endif
...
#if defined SWI_SENSEPI_BLE_USED
#if SWI_SENSEPI_BLE_USED == 0
    sensepi_ble_swi_Handler ();
#endif
#endif
