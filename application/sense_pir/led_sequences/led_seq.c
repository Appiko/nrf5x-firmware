...
LED_STRUCT2(adv_mode_seq, 5) = {
    {0, 0, 0, 0, 0},
    {0, 1000, 200, 0, 0}
};
const uint16_t adv_mode_duration[] = { 0, 1000, 1000, 2000, 1000, 5000 };
...
LED_STRUCT2(conn_mode_seq, 3) = {
    {0, 1000, 0},
    {0, 1000, 0}
};
const uint16_t conn_mode_duration[] = { 0, 2500, 2500, 5000 };
...
const uint32_t led_num_len[] = {2, 1, 2, 2, 2, 1};
const uint32_t led_seq_len[] = {5, 4, 5, 5, 3, 6};
const uint16_t * const led_seq_ptr[] = {(uint16_t *) &ramp_offset_seq, (uint16_t *) &pir_pulse_seq, (uint16_t *) &adv_mode_seq, (uint16_t *) &dual_freq_seq, (uint16_t *) &conn_mode_seq, (uint16_t *) &red_pulse_seq };
const uint16_t * const led_seq_duration_ptr[] = { ramp_offset_duration, pir_pulse_duration, adv_mode_duration, dual_freq_duration, conn_mode_duration, red_pulse_duration };
