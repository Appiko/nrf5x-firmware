...
const uint32_t led_num_len[] = {2, 2, 1};
const uint32_t led_seq_len[] = {5, 5, 6};
const uint16_t * const led_seq_ptr[] = {(uint16_t *) &ramp_offset_seq, (uint16_t *) &dual_freq_seq, (uint16_t *) &red_pulse_seq };
const uint16_t * const led_seq_duration_ptr[] = { ramp_offset_duration, dual_freq_duration, red_pulse_duration };
