/**
 *  senseberx_rev4.h : SenseBe Rev 4 board definitions
...
#ifndef PLATFORM_SENSEBERX_REV4_H_
#define PLATFORM_SENSEBERX_REV4_H_
 ...
 * @{*/
#define JACK_CAM_JACK            2
#define JACK_FOCUS_PIN           4
#define JACK_TRIGGER_PIN         3
/** @} */

/** @anchor sensebe_rev1_TSSP4056_receiver
 * @name TSSP4056 IR receiver output and enable pins definitions
 * @{*/
#define TSSP_RX_OUT       14
#define TSSP_RX_EN        15
/** @} */
...
#define IR_TX_LED_EN         10
/** Pin to control the Regulator */
#define IR_TX_REG_EN         11
/** Power control pin 1 */
#define IR_TX_PWR1           13
/** Power control pin 2 */
#define IR_TX_PWR2           12
...
#define SENSEBE_RX_TX_SEL_PIN  17
#define SENSEBE_RX_BOARD       0
#define SENSEBE_TX_BOARD       1
