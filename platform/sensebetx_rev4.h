/**
 *  sensebetx_rev4.h : SenseBe Rev 4 board definitions
...
#ifndef PLATFORM_SENSEBETX_REV4_H_
#define PLATFORM_SENSEBETX_REV4_H_
 ...
 * @{*/
#define JACK_CAM_JACK            4
#define JACK_FOCUS_PIN           2
