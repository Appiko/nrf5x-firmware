/**
 *  sensebe_rev1.h : SenseBe Rev 1 board definitions
 ...
 * @{
 *
 * @defgroup board_sensebe_rev1 Appiko Sense Be unit revision 1
 * @brief Board definitions for the 2nd revision of the transreceiver unit of SenseBe
...
/** @anchor sensebe_rev1_txrx_serial
